...
Encender un led dependiendo de la posición de la perilla de un pot resulta no demasiado práctico. En todo caso estaría infrautilizado el potenciómetro ya que esta tarea la puede realizar mejor un botón interruptor. Resulta más adecuado variar el brillo del led de manera proporcional al giro de la perilla del pot. Eso es lo que implementaremos ahora. NEcesitaremos:
