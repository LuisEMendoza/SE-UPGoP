...
Con el circuito y código anteriores tenemos al menos una secuencia similar a la de un semáforo. Sin embargo, no es el comportamiento que se espera de uno instalado en el mundo real. Modifique el código para obtener la secuencia que realmente sigue un semáforo en las calles. 
