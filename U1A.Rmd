...
Y ahora pasamos al ciclo de trabajo. Asignamos la lectura análoga del pot a la variable destinada (_ValorPot_), luego la mapeamos para hacerla proporcional al rango de valores de salida analógica. Obeservemos los argumentos a dar a la función _map_: ```map(variable_a_mapear, valor_a_mapear_inicial, valor_a_mapear_final, valor_mapeado_inicial, valor_mapeado_final)```.
