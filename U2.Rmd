...
> Si tenemos más de una _raspi_ o simplemente porque deseamos cambiarle el nombre, podemos hacerlo por medio de _raspi-config_ $\rightarrow$ _Network Options_ $\rightarrow$ _N1 Hostname_. Aceptamos el mensaje y al dar _Enter_ podremos escribir el nuevo nombre con el que aparecerá la placa en la red.
